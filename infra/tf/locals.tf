...
locals {
    ...
    azure_monitor_private_link_scope_name = "${var.resource_name_prefix}-${var.resource_name_base_name}-${var.environment_name}-ampls"
    log_analytics_workspace_name = "${var.resource_name_prefix}-${var.resource_name_base_name}-${var.environment_name}-laws"
    app_insights_name = "${var.resource_name_prefix}-${var.resource_name_base_name}-${var.environment_name}-ai"
    app_insights_instrumentation_key_secret_name = "APP-INSIGHTS-INSTRUMENTATION-KEY"
    app_insights_connection_string_secret_name = "APP-INSIGHTS-CONNECTION-STRING"
    azure_monitor_private_endpoint_name = "${var.resource_name_prefix}-${var.resource_name_base_name}-${var.environment_name}-ampls-pe"
}
